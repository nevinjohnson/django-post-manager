"""
Django settings for jsonpost_app project.
...
SECRET_KEY = 'django-insecure-v1hq4)#$q#57#jv%)!agkoy=vwj@2j%xkc51&c)7-)e-=!ri4*'
...
ROOT_URLCONF = 'jsonpost_app.urls'
...
WSGI_APPLICATION = 'jsonpost_app.wsgi.application'
